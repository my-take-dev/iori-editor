...
export function DiscardConfirmDialog({
  ...
  onConfirm,
  onCancel,
}: DiscardConfirmDialogProps): JSX.Element {
  return (
    <div
    ...
    >
      ...
      >
        <div className="px-5 py-3 border-b border-[#3c3c3c] bg-[#1e1e1e] rounded-t-lg">
          <h2 className="font-semibold text-[#cccccc] text-[14px]">変更を破棄</h2>
        </div>
        <div className="p-5">
          <p className="text-[#cccccc] text-[13px] mb-4">
            <span className="font-semibold text-[#e0e0e0]">{fileName}</span> の変更を破棄してもよろしいですか？
          </p>
